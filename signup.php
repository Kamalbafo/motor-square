...
if(isset($_POST['submit']))
{
	...
	//all the users which signup assign them 2 level 
	$level = 2; 

  if($fullName != null && $email != null && $password != null){
     
    $query = "INSERT INTO user(fullName,email,password,level) VALUES ('$fullName','$email','$password','$level')";
        ...
        <div class="container">
          <div class="authenticate flex-display m-left-md m-right-md">
            <div class="authenticate__details flex-display--column">
              ...
              <h1>Hello There, Create your Account 👋</h1>
             ...
             <br>
              ...
              <div class="authenticate__details--remember flex-display">
                <div class="flex-display">
                  ...
                  <p id="remember" name="remember">Accept Terms & Condition</p>
